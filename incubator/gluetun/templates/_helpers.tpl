...
*/}}
{{- define "gluetun.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "gluetun.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "gluetun.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "gluetun-ca" 365 -}}
{{- $cert := genSignedCert ( include "gluetun.name" . ) nil $altNames 365 $ca -}}
