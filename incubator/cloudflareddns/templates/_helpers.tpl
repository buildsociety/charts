...
*/}}
{{- define "cloudflareddns.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "cloudflareddns.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "cloudflareddns.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "cloudflareddns-ca" 365 -}}
{{- $cert := genSignedCert ( include "cloudflareddns.name" . ) nil $altNames 365 $ca -}}
