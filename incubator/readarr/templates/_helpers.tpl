...
*/}}
{{- define "readarr.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "readarr.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "readarr.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "readarr-ca" 365 -}}
{{- $cert := genSignedCert ( include "readarr.name" . ) nil $altNames 365 $ca -}}
