...
*/}}
{{- define "tautulli.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "tautulli.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "tautulli.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "tautulli-ca" 365 -}}
{{- $cert := genSignedCert ( include "tautulli.name" . ) nil $altNames 365 $ca -}}
