...
*/}}
{{- define "sabnzbd.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "sabnzbd.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "sabnzbd.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "sabnzbd-ca" 365 -}}
{{- $cert := genSignedCert ( include "sabnzbd.name" . ) nil $altNames 365 $ca -}}
