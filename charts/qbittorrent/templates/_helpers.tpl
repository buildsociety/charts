...
*/}}
{{- define "qbittorrent.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "qbittorrent.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "qbittorrent.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "qbittorrent-ca" 365 -}}
{{- $cert := genSignedCert ( include "qbittorrent.name" . ) nil $altNames 365 $ca -}}
