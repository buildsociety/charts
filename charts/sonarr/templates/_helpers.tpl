...
*/}}
{{- define "sonarr.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "sonarr.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "sonarr.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "sonarr-ca" 365 -}}
{{- $cert := genSignedCert ( include "sonarr.name" . ) nil $altNames 365 $ca -}}
