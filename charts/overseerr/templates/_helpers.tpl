...
*/}}
{{- define "overseerr.gen-certs" -}}
{{- $altNames := list ( printf "%s.%s" (include "overseerr.name" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "overseerr.name" .) .Release.Namespace ) -}}
{{- $ca := genCA "overseerr-ca" 365 -}}
{{- $cert := genSignedCert ( include "overseerr.name" . ) nil $altNames 365 $ca -}}
